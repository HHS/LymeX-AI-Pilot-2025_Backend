...
def accept(access_token: str, company_id: str, product_id: str):
    url = f"{environment.base_url}/product/{product_id}/claim-builder/accept"
    headers = {
...
def test() -> None:
    ...
    accept(access_token, company_id, product_id)
