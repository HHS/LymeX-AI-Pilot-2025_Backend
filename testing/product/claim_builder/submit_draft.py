...
def submit_draft(access_token: str, company_id: str, product_id: str):
    url = f"{environment.base_url}/product/{product_id}/claim-builder/draft/submit"
    headers = {
...
def test() -> None:
    ...
    try:
        result = submit_draft(access_token, company_id, product_id)
