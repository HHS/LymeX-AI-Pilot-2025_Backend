...
def get_first_result_compare(
    access_token: str, company_id: str, product_id: str, competitive_analysis_id: str
) -> dict:
    url = f"{environment.base_url}/product/{product_id}/competitive-analysis/result/{competitive_analysis_id}/compare"
    headers = {
...
def test() -> None:
    ...
    result = get_first_result_compare(
