...
def analyze(access_token: str, company_id: str, product_id: str):
    url = f"{environment.base_url}/product/{product_id}/competitive-analysis/analyze"
    headers = {
...
def test() -> None:
    ...
    analyze(access_token, company_id, product_id)
