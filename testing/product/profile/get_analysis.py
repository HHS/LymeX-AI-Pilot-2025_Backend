...
def get_profile_analysis(access_token: str, company_id: str, product_id: str):
    url = f"{environment.base_url}/product/{product_id}/profile/analysis"
    headers = {
...
def test() -> None:
    ...
    product_profile = get_profile_analysis(access_token, company_id, product_id)
