...
def update(access_token: str, company_id: str, product_id: str):
    url = f"{environment.base_url}/product/{product_id}/profile/"
    headers = {
...
def test() -> None:
    ...
    product_profile = update(access_token, company_id, product_id)
