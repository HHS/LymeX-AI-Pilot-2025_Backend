...
def get_product_version_control(access_token: str, company_id: str, product_id: str):
    url = f"{environment.base_url}/product/{product_id}/version-control"
    headers = {
...
def get_first_analyze_product_version_control(
    ...
    product_version_controls = get_product_version_control(
...
def test() -> None:
    ...
    product_version_control = get_product_version_control(
        access_token, company_id, product_id
    )
    print(
