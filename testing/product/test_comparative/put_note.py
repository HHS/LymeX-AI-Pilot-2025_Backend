...
def put_note(access_token: str, company_id: str, product_id: str):
    ...
    response = requests.put(
        url,
        headers=headers,
        json={"note": "This is a test note for the product test comparison."},
    )
    try:
...
def test() -> None:
    ...
    product_test_comparison = put_note(access_token, company_id, product_id)
