...
def get_note_document(access_token: str, company_id: str, product_id: str):
    url = f"{environment.base_url}/product/{product_id}/test-comparison/note/document-urls"
    headers = {
...
def test() -> None:
    ...
    product_test_comparison = get_note_document(access_token, company_id, product_id)
