...
def analyze(access_token: str, company_id: str, product_id: str, test_id: str):
    url = f"{environment.base_url}/product/{product_id}/performance-testing/{test_id}/analyze"
    headers = {
...
def test() -> None:
    ...
    analyze(access_token, company_id, product_id, first_performance_testing["id"])
