...
from src.modules.checklist.schema import (
    ChecklistQuestion,
    ChecklistProgress,
    ChecklistResponse,
)
...
async def upload_checklist_file(
    product_id: str, question_id: str, file: UploadFile
) -> Dict[str, Any]:
...
async def get_checklist_documents(
    product_id: str, question_id: str = None
) -> Dict[str, Any]:
...
def create_checklist_response(
    checklist: Checklist, product_name: str, product_code: str | None
) -> ChecklistResponse:
...
async def get_or_create_checklist(product_id: str) -> Dict[str, Any]:
    ...
    # Convert to response format with product data
    checklist_response = create_checklist_response(
        new_checklist, product_name, product_code
    )
