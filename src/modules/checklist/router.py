...
async def create_master_checklist():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error creating master checklist: {str(e)}")
...
async def get_master_checklist():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error fetching master checklist: {str(e)}")
...
async def get_or_create_checklist(product_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error getting/creating checklist: {str(e)}")
